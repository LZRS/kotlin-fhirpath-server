...
class FhirR5Service : FhirpathService {
  private val resourceParser = FhirR5Json()
  private val json = Json {}
  private val fhirpathEngine = FhirPathEngine.forR5()
      ...
      val results =
        if (!inputData.contextExpression.isNullOrBlank()) {
          ...
          contextResult.mapIndexed { index, contextValue ->
            ...
            val expressResultAsParameters =
              expressionResult.map { convertEvalResultToParameter(it) }
            val traceDataAsParameters =
              fhirpathEngine.traces.map { entry ->
                  ...
                  buildList {
                    ...
                    inputData.contextExpression?.let {
                      add(
                        Parameters.Parameter(
                          ...
                          value =
                            Parameters.Parameter.Value.String(
                              value = FhirString(value = inputData.contextExpression)
                            ),
                        )
                      )
                    }
                    ...
                    add(
                      Parameters.Parameter(
                        ...
                        value =
                          Parameters.Parameter.Value.String(
                            value = FhirString(value = inputData.expression)
                          ),
                      )
                    )
                    ...
                    if (inputData.variables.isNotEmpty()) {
                      add(
                        Parameters.Parameter(
                          ...
                          part =
                            inputData.variables.map {
                              Parameters.Parameter(
                                name = FhirString(value = it.key),
                                value =
                                  Parameters.Parameter.Value.String(
                                    value = FhirString(value = it.value)
                                  ),
                              )
                            },
                        )
  ...
  private fun convertEvalResultToParameter(
    evalResult: Any,
    ...
    return when (evalResult) {
      is BigDecimal ->
        Parameters.Parameter(
          ...
          value = Parameters.Parameter.Value.Decimal(value = Decimal(value = evalResult)),
        )
      is FhirPathQuantity ->
        Parameters.Parameter(
        ...
        Parameters.Parameter(
          ...
          value =
            Parameters.Parameter.Value.DateTime(
              value = DateTime(value = FhirDateTime.fromString(evalResult.toString()))
            ),
        )
      is FhirPathDate ->
        Parameters.Parameter(
          ...
          value =
            Parameters.Parameter.Value.Date(
              value = Date(value = FhirDate.fromString(evalResult.toString()))
            ),
        )
      is FhirPathTime ->
        Parameters.Parameter(
          name = FhirString(value = "time"),
          value = Parameters.Parameter.Value.Time(value = Time(value = evalResult.toLocalTime())),
        )
      is Int ->
        Parameters.Parameter(
          name = FhirString(value = "integer"),
          value = Parameters.Parameter.Value.Integer(value = FhirInteger(value = evalResult)),
        )
      is Boolean ->
        Parameters.Parameter(
          name = FhirString(value = "boolean"),
          value = Parameters.Parameter.Value.Boolean(value = FhirBoolean(value = evalResult)),
        )
      is String ->
        Parameters.Parameter(
          name = FhirString(value = "string"),
          value = Parameters.Parameter.Value.String(value = FhirString(value = evalResult)),
        )

      is Base64Binary ->
        Parameters.Parameter(
          name = FhirString(value = "base64Binary"),
          value = Parameters.Parameter.Value.Base64Binary(evalResult),
        )
      is Canonical ->
        Parameters.Parameter(
          name = FhirString(value = "canonical"),
          value = Parameters.Parameter.Value.Canonical(evalResult),
        )
      is Code ->
        Parameters.Parameter(
          name = FhirString(value = "code"),
          value = Parameters.Parameter.Value.Code(evalResult),
        )
      is Date ->
        Parameters.Parameter(
          name = FhirString(value = "date"),
          value = Parameters.Parameter.Value.Date(evalResult),
        )
      is Id ->
        Parameters.Parameter(
          name = FhirString(value = "id"),
          value = Parameters.Parameter.Value.Id(evalResult),
        )
      is Instant ->
        Parameters.Parameter(
          name = FhirString(value = "instant"),
          value = Parameters.Parameter.Value.Instant(evalResult),
        )
      is Markdown ->
        Parameters.Parameter(
          name = FhirString(value = "markdown"),
          value = Parameters.Parameter.Value.Markdown(evalResult),
        )
      is Oid ->
        Parameters.Parameter(
          name = FhirString(value = "oid"),
          value = Parameters.Parameter.Value.Oid(evalResult),
        )
      is PositiveInt ->
        Parameters.Parameter(
          name = FhirString(value = "positiveInt"),
          value = Parameters.Parameter.Value.PositiveInt(evalResult),
        )
      is UnsignedInt ->
        Parameters.Parameter(
          name = FhirString(value = "unsignedInt"),
          value = Parameters.Parameter.Value.UnsignedInt(evalResult),
        )
      is Uuid ->
        Parameters.Parameter(
          name = FhirString(value = "uuid"),
          value = Parameters.Parameter.Value.Uuid(evalResult),
        )
      is Url ->
        Parameters.Parameter(
          name = FhirString(value = "url"),
          value = Parameters.Parameter.Value.Url(evalResult),
        )
      is Uri ->
        Parameters.Parameter(
          name = FhirString(value = "uri"),
          value = Parameters.Parameter.Value.Uri(evalResult),
        )
      is Address ->
        Parameters.Parameter(
          name = FhirString(value = "address"),
          value = Parameters.Parameter.Value.Address(evalResult),
        )
      is Age ->
        Parameters.Parameter(
          name = FhirString(value = "age"),
          value = Parameters.Parameter.Value.Age(evalResult),
        )
      is FhirAnnotation ->
        Parameters.Parameter(
          name = FhirString(value = "annotation"),
          value = Parameters.Parameter.Value.Annotation(evalResult),
        )
      is Attachment ->
        Parameters.Parameter(
          name = FhirString(value = "attachment"),
          value = Parameters.Parameter.Value.Attachment(evalResult),
        )
      is CodeableConcept ->
        Parameters.Parameter(
          name = FhirString(value = "codeableConcept"),
          value = Parameters.Parameter.Value.CodeableConcept(evalResult),
        )
      is Coding ->
        Parameters.Parameter(
          name = FhirString(value = "coding"),
          value = Parameters.Parameter.Value.Coding(evalResult),
        )
      is ContactPoint ->
        Parameters.Parameter(
          name = FhirString(value = "contactPoint"),
          value = Parameters.Parameter.Value.ContactPoint(evalResult),
        )
      is Count ->
        Parameters.Parameter(
          name = FhirString(value = "count"),
          value = Parameters.Parameter.Value.Count(evalResult),
        )
      is Distance ->
        Parameters.Parameter(
          name = FhirString(value = "distance"),
          value = Parameters.Parameter.Value.Distance(evalResult),
        )
      is Duration ->
        Parameters.Parameter(
          name = FhirString(value = "duration"),
          value = Parameters.Parameter.Value.Duration(evalResult),
        )
      is HumanName ->
        Parameters.Parameter(
          name = FhirString(value = "humanName"),
          value = Parameters.Parameter.Value.HumanName(evalResult),
        )
      is Identifier ->
        Parameters.Parameter(
          name = FhirString(value = "identifier"),
          value = Parameters.Parameter.Value.Identifier(evalResult),
        )
      is Money ->
        Parameters.Parameter(
          name = FhirString(value = "money"),
          value = Parameters.Parameter.Value.Money(evalResult),
        )
      is Period ->
        Parameters.Parameter(
          name = FhirString(value = "period"),
          value = Parameters.Parameter.Value.Period(evalResult),
        )
      is Quantity ->
        Parameters.Parameter(
          name = FhirString(value = "quantity"),
          value = Parameters.Parameter.Value.Quantity(evalResult),
        )
      is Range ->
        Parameters.Parameter(
          name = FhirString(value = "range"),
          value = Parameters.Parameter.Value.Range(evalResult),
        )
      is Ratio ->
        Parameters.Parameter(
          name = FhirString(value = "ratio"),
          value = Parameters.Parameter.Value.Ratio(evalResult),
        )
      is Reference ->
        Parameters.Parameter(
          name = FhirString(value = "reference"),
          value = Parameters.Parameter.Value.Reference(evalResult),
        )
      is SampledData ->
        Parameters.Parameter(
          name = FhirString(value = "sampledData"),
          value = Parameters.Parameter.Value.SampledData(evalResult),
        )
      is Signature ->
        Parameters.Parameter(
          name = FhirString(value = "signature"),
          value = Parameters.Parameter.Value.Signature(evalResult),
        )
      is Timing ->
        Parameters.Parameter(
          name = FhirString(value = "timing"),
          value = Parameters.Parameter.Value.Timing(evalResult),
        )
      is ContactDetail ->
        Parameters.Parameter(
          name = FhirString(value = "contactDetail"),
          value = Parameters.Parameter.Value.ContactDetail(evalResult),
        )
      //            is Contributor -> Parameters.Parameter(name = FhirString(value = "contributor"),
      // value = Parameters.Parameter.Value.Contributor(evalResult))
      is DataRequirement ->
        Parameters.Parameter(
          name = FhirString(value = "dataRequirement"),
          value = Parameters.Parameter.Value.DataRequirement(evalResult),
        )
      is Expression ->
        Parameters.Parameter(
          name = FhirString(value = "expression"),
          value = Parameters.Parameter.Value.Expression(evalResult),
        )
      is ParameterDefinition ->
        Parameters.Parameter(
          name = FhirString(value = "parameterDefinition"),
          value = Parameters.Parameter.Value.ParameterDefinition(evalResult),
        )
      is RelatedArtifact ->
        Parameters.Parameter(
          name = FhirString(value = "relatedArtifact"),
          value = Parameters.Parameter.Value.RelatedArtifact(evalResult),
        )
      is TriggerDefinition ->
        Parameters.Parameter(
          name = FhirString(value = "triggerDefinition"),
          value = Parameters.Parameter.Value.TriggerDefinition(evalResult),
        )
      is UsageContext ->
        Parameters.Parameter(
          name = FhirString(value = "usageContext"),
          value = Parameters.Parameter.Value.UsageContext(evalResult),
        )
      is Dosage ->
        Parameters.Parameter(
          name = FhirString(value = "dosage"),
          value = Parameters.Parameter.Value.Dosage(evalResult),
        )
      is Meta ->
        Parameters.Parameter(
          name = FhirString(value = "meta"),
          value = Parameters.Parameter.Value.Meta(evalResult),
        )
      else ->
        Parameters.Parameter(
          extension =
              ...
              Extension(
                ...
                value =
                  Extension.Value.String(
                    value =
                      FhirString(value = json.encodeToString(DynamicLookupSerializer(), evalResult))
                  ),
              )
            ),
    ...
    //                it.copy(extension = extension + Extension(url =
    // "http://fhir.forms-lab.com/StructureDefinition/resource-path", value =
    // Extension.Value.String(value = FhirString(value = resourcePath))))
    //            } else it
    //        }
  }
}

...
internal class FhirPathR4BService : AbstractFhirPathService<Parameters.Parameter, Resource>() {
  override val evaluatorLabel = "Kotlin FHIRPath (R4B)"
  override val fhirpathEngine = FhirPathEngine.forR4B()
  ...
  override fun convertFhirTypeToParameter(value: Any): Parameters.Parameter = when (value) {
    ...
    is Contributor -> Parameters.Parameter(name = FhirString(value = "contributor"), value = Parameters.Parameter.Value.Contributor(
      value
    ))
